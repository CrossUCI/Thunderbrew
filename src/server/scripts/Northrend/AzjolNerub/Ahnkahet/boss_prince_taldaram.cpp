                    ...
                    case CASTING_FLAME_SPHERES:
                    {
                        ...
                        if (IsHeroic())
                        {
                            ...
                            if (pSphereTarget && pSpheres[1] && pSpheres[2])
                            {
                                ...
                                x = pSpheres[1]->GetPositionX() + (float)DATA_SPHERE_DISTANCE/2 * std::cos(angle);
                                y = pSpheres[1]->GetPositionY() + (float)DATA_SPHERE_DISTANCE/2 * std::sin(angle);
                                ...
                                x = pSpheres[2]->GetPositionX() + (float)DATA_SPHERE_DISTANCE/2 * std::cos(angle);
                                y = pSpheres[2]->GetPositionY() + (float)DATA_SPHERE_DISTANCE/2 * std::sin(angle);
