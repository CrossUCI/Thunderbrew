...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_RATED_10_VS_10 = 16,
    BATTLEGROUND_QUEUE_RATED_15_VS_15 = 17,
    BATTLEGROUND_QUEUE_RATED_25_VS_25 = 18,
    BATTLEGROUND_QUEUE_DG             = 19,
...
class Battleground
{
    public:
        ...
        void InitGUID() {m_Guid = MAKE_NEW_GUID(m_TypeID, 0, (HighGuid)0x01F1); }
        void SetRandomTypeID(BattlegroundTypeId TypeID) { m_RandomTypeID = TypeID; }
        BattlegroundTypeId GetRandomTypeID() { return m_RandomTypeID; }
        ...
        BattlegroundScoreMap GetPlayerScores() const { return PlayerScores; }

        BattlegroundScoreMap const& GetBattlegroundScoreMap() { return PlayerScores; }
        ...
        virtual void EventPlayerClickedOnFlag(Player* /*source*/, Unit* /*target*/) {}
        virtual bool CanSeeSpellClick(Player const* player, Unit const* clicked) { return false; }
    ...
    protected:
        uint32 BuildArenaOpponentSpecializations(WorldPacket* data, uint32 team);
