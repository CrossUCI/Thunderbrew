...
#define DEFINE_IR_OPCODE_HANDLER(opcode, handler) \
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_BAN_CHARACTER,             &InterRealmSession::Handle_ClientSide          );
    //DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BAN,                       &InterRealmSession::Handle_Null                  );
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BAN_CHARACTER,             &InterRealmSession::Handle_BanCharacter                  );
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_BAN_INTERREALM_PLAYER,      &InterRealmSession::Handle_ClientSide    );
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BAN_INTERREALM_PLAYER_RESP, &InterRealmSession::Handle_BanInterRealmCharacterResponse );
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_ANTICHEAT_REPORT_NOTIFICATION, &InterRealmSession::Handle_AnticheatReportNotification );

    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_CHARACTER_SKILLS,          &InterRealmSession::Handle_ClientSide  );
    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_CHARACTER_QUESTS,          &InterRealmSession::Handle_ClientSide  );
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_SYNC_PLAYER_CURRENCY,      &InterRealmSession::Handle_SyncPlayerCurrency);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_SYNC_PLAYER_ACHIEVEMENTS,  &InterRealmSession::Handle_SyncPlayerAchievements);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_SYNC_PLAYER_REPUTATION,    &InterRealmSession::Handle_SyncPlayerReputation);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_SYNC_PLAYER_KILLS,         &InterRealmSession::Handle_SyncPlayerKills);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_SYNC_PLAYER_QUESTS,        &InterRealmSession::Handle_SyncPlayerQuests);
